...
/**
 * Stores all data of application. Uses 1/mentions (of contact) as edge weight.
 */
public class StoreMentions extends BaseStore {
  ...
  protected static class Singleton {
    ...
    /**
     * Add a mention to an user. Add to user mention list. Updates weights on
     * edges.
     *
    ...
    /**
     * Remove a mention from an user. Remove from user mention list. Updates
     * weights on edges.
     *
     * @param from user reference
    ...
    /**
     * Implements the weight when adding and edge. Uses 1/mentions (from To
     * person).
     *
