...
public class PersonEmailOrderedList extends OrderedArrayList<Person> implements OrderedListADT<Person> {
     ...
     * array on proper location. Order by email.
     *
    ...
    /**
     * Search a person by email. Uses recursion to binary search in ordered
     * list. Throws ElementNotFoundException if there is no person with desired
     * email.
     *
