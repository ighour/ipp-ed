...
import ed.trabalho.helpers.*;
import ed.trabalho.json.Pessoa;
import ed.trabalho.resources.Base;
import ed.trabalho.resources.form.intermediate.*;
...
public class JMenu extends Base {
  ...
  private void initComponents() {
    ...
    /**
     * Open file chooser to select JSON input. Stores converted JSON info on
     * json attribute. Construct the network after converting JSON. For
     * requirement: "Carregar o grafo social a partir de um ficheiro JSON".
     *
     * @param evt event
     */
  ...
  private void graphMenuViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphMenuViewActionPerformed
      try {
          ...
          switch (BaseStore.getStoreType()) {
              case "CONSTANT":
                  title = "Social Network (Edges = 1)";
                  break;
              case "MENTIONS":
                  title = "Social Network (Edges = 1 / mentions of the contact)";
                  break;
              default:
                  title = "Social Network (Edges = 1 / visualizations of the contact)";
          }
    ...
    /**
     * For requirement: "A informação de um utilizador pode ser consultada
     * usando o email".
     *
     * @param evt event
     */
  ...
  private void userMenuSearchByEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userMenuSearchByEmailActionPerformed
    ...
    /**
     * For requirement: "Criar funções para testar se o grafo é completo (os
     * utilizadores estão todos ligados entre si)".
     *
     * @param evt event
     */
  private void graphMenuIsCompleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphMenuIsCompleteActionPerformed
    ...
    /**
     * For requirement: "Verificar se dois utilizadores se encontram ligados
     * entre si e apresentar o caminho mais curto entre eles usando as métricas
     * descritas".
     *
     * @param evt event
     */
  private void graphMenuMinimalPathVerticesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphMenuMinimalPathVerticesActionPerformed
    ...
    /**
     * For requirement: "Verificar quais os utilizadores que são alcançáveis a
     * partir de um determinado utilizador".
     *
     * @param evt event
     */
  private void graphMenuRechableUsersByUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphMenuRechableUsersByUserActionPerformed
    ...
    /**
     * For requirement: "Listar utilizadores que não são possíveis de contactar,
     * a partir de um determinado utilizador".
     *
     * @param evt event
     */
  private void graphMenuNotReachableUsersByUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_graphMenuNotReachableUsersByUserActionPerformed
    ...
    /**
     * For requirement: "Apresentar uma lista de utilizadores de uma empresa
     * passada como parâmetro que estão relacionados com um utilizador também
  ...
  private void userMenuCompareCompanyPeopleAndPersonContactsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userMenuCompareCompanyPeopleAndPersonContactsActionPerformed
    ...
    /**
     * For requirement: "Apresentar uma lista de utilizadores que contém um
     * determinado skill no seu perfil ordenado pelo menor custo de ligação. O
     * método deverá ter como parâmetro o utilizador inicial".
     *
     * @param evt event
     */
  ...
  private void userMenuAddUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userMenuAddUserActionPerformed
    ...
    /**
     * For extra requirement: "Teste dos graus de separação entre utilizadores
     * da plataforma (O número de mínimo de ligações para um utilizador se
     * conectar a todos os outros utilizadores no grafo social)".
     *
     * @param evt event
     */
  private void extraMenuMinimalLinksToEveryoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_extraMenuMinimalLinksToEveryoneActionPerformed
    ...
    /**
     * For extra requirement: "Apresentar a média de menções e ligações dos
  ...
  private void extraMenuMentionContactMediaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_extraMenuMentionContactMediaActionPerformed
    ...
    /**
     * Change edge weight to constant (1). For extra requirement: "Alterar as
     * funções que impliquem o cálculo do caminho mais curto: constante com
     * valor fixo para todas as ligações".
     *
     * @param evt event
     */
  ...
  private void extraMenuWeightDefaultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_extraMenuWeightDefaultActionPerformed
    ...
    /**
     * Change edge weight to mentions (1/mentions). For extra requirement:
     * "Alterar as funções que impliquem o cálculo do caminho mais curto: pelo
     * número de menções que um utilizador".
     *
     * @param evt event
     */
  private void extraMenuWeightMentionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_extraMenuWeightMentionsActionPerformed
    ...
    /**
     * For requirement: "Verificar a partir de um dado utilizador qual a lista
     * de utilizadores que fazem parte dos contactos da lista de contactos que
     * têm determinados skills / trabalharam em determinada empresa. Em resumo
     * todas as pessoas que o utilizador pode contactar via 1 único
     * intermediário.".
     *
     * @param evt event
     */
  private void usersMenuContactsContactsSkillsCompanyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_usersMenuContactsContactsSkillsCompanyActionPerformed
    ...
    /**
     * For requirement: "Verificar que os utilizadores que ocupam um cargo numa
     * empresa (ex: empresa A) não estão relacionados com a utilizadores com
     * cargos noutra empresa passada como parâmetro (empresa B)".
     *
     * @param evt event
     */
