...
public abstract class BasePerson extends Base {
    ...
    /**
     * Get the current person. To manipulate in forms.
     *
     * @return current user
     */
    ...
    /**
     * Process submit of email. Also, updates on peopleByEmail list.
     *
     * @param field email
     */
    ...
    /**
     * Process submit of visualizations. Also, updates edges on network. For
     * requirement: "Editar as ligações e visualizações no grafo após ser
     * carregado do ficheiro".
     *
    ...
    /**
     * Process submit of contact create. For requirement: "Editar as ligações e
     * visualizações no grafo após ser carregado do ficheiro".
     */
    ...
    /**
     * Process submit of contact delete. For requirement: "Editar as ligações e
     * visualizações no grafo após ser carregado do ficheiro".
     *
