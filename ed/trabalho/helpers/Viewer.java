...
/**
 * Creates a view of the network. Using Jung dependency.
 */
public class Viewer {
    ...
    public void create(SocialNetwork source, String storeType) {
        ...
        //Set labels
        this.vv.getRenderContext().setVertexLabelTransformer((Function<Person, String>) i -> {
            return "[" + i.getId() + "]";
        });
        this.vv.getRenderContext().setEdgeLabelTransformer((Function<ViewNode, String>) i -> {
            return i.toString();
        });
    ...
    /**
     * View Node to store edge info. Uses 1/visualizations.
     */
    ...
    /**
     * View Node to store edge info. Uses 1.
     */
    ...
    /**
     * View Node to store edge info. Uses 1/mentions.
     */
